...
class PruebasControllerTest < ActionController::TestCase
  ...
  test "should create prueba" do
    assert_difference('Prueba.count') do
      post :create, prueba: { apellido: @prueba.apellido, nombre: @prueba.nombre, telefono: @prueba.telefono }
    end
  ...
  test "should update prueba" do
    patch :update, id: @prueba, prueba: { apellido: @prueba.apellido, nombre: @prueba.nombre, telefono: @prueba.telefono }
    assert_redirected_to prueba_path(assigns(:prueba))
  end
